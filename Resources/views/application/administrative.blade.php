		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="{{ route('promotion.application.index') }}">My Applications</a></li>
		...
		<div class="card">
			<div class="card-header">
                ...
                <div class="float-right">
                    ...
                    <a href="{{route('promotion.application.download', $application)}}" class="btn btn-sm btn-outline-primary" target="_blank" >
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-12 col-sm-12">                    
                        <div class="nav flex-column nav-pills offset-lg-1" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link"  data-toggle="pill" href="#service" role="tab" aria-controls="service" aria-selected="false">Luanar Service</a>
                            <a class="nav-link"  data-toggle="pill" href="#duties" role="tab" aria-controls="duties" aria-selected="true">Duties Performed</a>
                            ...
                            <a class="nav-link"  data-toggle="pill" href="#experience" role="tab" aria-controls="experience" aria-selected="false">Previous Employment</a>
                            ...
                            <a class="nav-link"  data-toggle="pill" href="#awards" role="tab" aria-controls="awards" aria-selected="false">Academic Awards</a>
                    ...
                    <div class="col-lg-10 col-md-12 col-sm-12">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="duties" role="tabpanel" >
                                <livewire:promotion::application.duties-form :application="$application"  />
                            </div>
                
                            <div class="tab-pane fade" id="service" role="tabpanel" >
                                <livewire:promotion::application.service-form :staff="$staff"  />
                            </div>

                            <div class="tab-pane fade" id="experience" role="tabpanel" >
                                <livewire:promotion::application.experience-form :staff="$staff"  />
                            </div>
                
                            <div class="tab-pane fade" id="qualifications" role="tabpanel" >
                                <livewire:promotion::application.qualification-form :staff="$staff"  />
                            </div>
                            
                            <div class="tab-pane fade" id="awards" role="tabpanel" >
                                <livewire:promotion::application.award-form :staff="$staff"  />
                            </div>
                
                            <div class="tab-pane fade" id="achievements" role="tabpanel" >
                                <livewire:promotion::application.achievement-form :application="$application"  />
                            </div>
                
                            <div class="tab-pane fade" id="reference" role="tabpanel" >
                                <livewire:promotion::application.referee-form :staff="$staff"  />
                            </div>
